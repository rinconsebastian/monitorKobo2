...
namespace App_consulta.Migrations
{
    ...
    [Migration("20220722140524_ft-iv-046")]
    partial class ftiv046
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App_consulta.Models.AquacultureField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("GroupMap")
                        .HasMaxLength(50)
                    ...
                    b.ToTable("AquacultureField");
                });

            modelBuilder.Entity("App_consulta.Models.AquacultureVariable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App_consulta.Models.Policy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 24,
                            claim = "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/Acuicultura.Listado",
                            group = 8,
                            nombre = "Informe acuicultura"
                        },
                        new
                        {
                            id = 25,
                            claim = "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/Acuicultura.Imprimir",
                            group = 8,
                            nombre = "Imprimir acuicultura"
                        });
                });
